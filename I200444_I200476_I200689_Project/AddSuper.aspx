<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddSuper.aspx.cs" Inherits="I200444_I200476_I200689_Project.AddSuper" %>
...
.mainbtn:active{
    ...
    <h1>Register Supervisors</h1>
    <br /><br /><br /><br />
    <div class="container">
        <formview>
            <div class="form">
                <div class="sub-form">
                    <asp:TextBox runat="server" ID="TB1" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Supervisor First Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" ID="TB2" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Supervisor Last Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" ID="TB3" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Supervisor Username</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" ID="TB4" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Supervisor Password</span>
                </div>
                <br /><br />
                <asp:Button runat="server" CssClass="submit" Text="Register" OnClick="Register_Super"/>
                <br /><br />
            </div>
        </formview>
