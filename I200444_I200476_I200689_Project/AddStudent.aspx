<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddStudent.aspx.cs" Inherits="I200444_I200476_I200689_Project.AddStudent" %>
...
.mainbtn:active{
    ...
    <h1>Register Student Accounts</h1>
    <br /><br /><br /><br />
    <div class="container">
        <formview runat="server">
            <div class="form">
                <div class="sub-form">
                    ...
                    <span style="font-size:medium">Student First Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox ID="TB2" runat="server" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Student Last Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox ID="TB3" runat="server" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Student Username</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox ID="TB4" runat="server" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Student Password</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox ID="TB5" runat="server" CssClass="TBox"></asp:TextBox>
                    <span style="font-size:medium">Project Title</span>
                </div>
                <br />
                <asp:Button runat="server" Text="Register" CssClass="btn" OnClick="Register_Student"/>
            </div>
        </formview>
