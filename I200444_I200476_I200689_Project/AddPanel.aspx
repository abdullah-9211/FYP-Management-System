<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="AddPanel.aspx.cs" Inherits="I200444_I200476_I200689_Project.AddPanel" %>
...
.mainbtn:active{
    ...
    <h1>Register Panel Members</h1>
    <br /><br /><br /><br />
    <div class="container">
        <formview>
            <div class="form">
                <div class="sub-form">
                    <asp:TextBox runat="server" CssClass="TBox" ID="TB1"></asp:TextBox>
                    <span style="font-size:medium">Panel Member First Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" CssClass="TBox" ID="TB2"></asp:TextBox>
                    <span style="font-size:medium">Panel Member Last Name</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" CssClass="TBox" ID="TB3"></asp:TextBox>
                    <span style="font-size:medium">Panel Member Username</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" CssClass="TBox" ID="TB4"></asp:TextBox>
                    <span style="font-size:medium">Panel Member Password</span>
                </div>
                <br />
                <div class="sub-form">
                    <asp:TextBox runat="server" CssClass="TBox" ID="TB5"></asp:TextBox>
                    <span style="font-size:medium">Panel ID</span>
                </div>
                <br />
                <asp:Button runat="server" Text="Register" CssClass="btn" OnClick="Register_Panel"/>
            </div>
        </formview>
