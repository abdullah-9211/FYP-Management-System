...
namespace I200444_I200476_I200689_Project
{
    public partial class AddPanel : System.Web.UI.Page
    {
        ...
        protected void Register_Panel(object sender, EventArgs e)
        {
            ...
            string Query = "INSERT INTO [USER] VALUES('" + user + "', '" + pass + "', '" + fname + "', '" + lname + "', 'Faculty', 'Panel Member');INSERT INTO [PANEL MEMBER] VALUES(" + pid + ", '" + user + "');";
            ...
            if (check != 0)
            {
                Query = "INSERT INTO [AUDIT TRAIL] VALUES('" + curr_user + "', CONVERT(DATE,'" + curr_date + "'), CONVERT(TIME, '" + time + "'), 'Added " + fname + " " + lname + "s Panel Account');";
